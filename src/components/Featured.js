...
const Featured = () => {
  return (
    <section class="px-6 md:px-8 lg:px-16 py-4 lg:py-6 bg-lightest-white-bg text-light-black">
      <div className="uppercase text-center mb-6">as featured on</div>
      <div class="w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-y-12">
        <div className="border-l-4 md:border-l-0 border-r-4 border-light-green flex items-center justify-center py-4">
          <span>
            <img src={forbes} alt="logo" width="130px" height="auto" />
          </span>
        </div>
        ...
        <div className="border-l-4 border-r-4 md:border-l-0  md:border-r-0 border-light-green flex flex-row justify-center items-center py-4">
          <span>
            <img src={tradingview} alt="logo" width="200px" height="auto" />
          </span>
        </div>
      </div>
    </section>
