...
const Features = () => {
  return (
    <section class="px-8 lg:px-12 py-12 lg:py-16 text-light-black features-bg">
      <div>
        <img
          src={require("../assets/images/FeaturesLeftGlow.png")}
          alt=""
          className="features-left-glow"
        />
        <img
          src={require("../assets/images/FeaturesRightGlow.png")}
          alt=""
          className="features-right-glow"
        />
        <img
          src={require("../assets/images/FeaturesDataAnalyticsRight.png")}
          alt=""
          className="features-right-dataAnalytics"
        />
        <img
          src={require("../assets/images/FeaturesDataAnalyticsLeft.png")}
          alt=""
          className="features-left-dataAnalytics"
        />
