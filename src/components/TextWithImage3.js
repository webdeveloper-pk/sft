...
const TextWithImage3 = () => (
    <section class="pr-6 mr:px-8 xl:pr-16 bg-lightest-white-bg">
        <div class="mx-auto flex flex-col py-12 lg:flex-row items-end gap-y-8 gap-x-6 lg:py-16">
            ...
            <div className="w-full lg:w-1/2 flex flex-col text-center md:text-left md:pl-8 lg:pl-0">
                <h1 className="text-2xl md:text-4xl mb-4 font-bold uppercase">
                    JOIN A UNIQUE AND INSPIRING
                    <br />
                    TRADING COMMUNITY!
                </h1>
                <div className="flex flex-row ml-2 items-start text-sm xl:text-base w-full lg:w-[90%] xl:w-[80%]">
                    <div className="border-l border-2 border-light-green h-[20px] mt-2" />
                    <div className="ml-4 text-lighter-black">
                        <p className="mt-1">
                            At SFT, we understand the struggles of being a trader, that's
                            why we created a community of like-minded individuals who
                            understand the industry and share the same goal of financial
                            freedom.
                        </p>
                        <p className="mt-4">
                            ...
                            experts, exchange market insights and connect with other
                            traders.
                        </p>
                    </div>
                </div>
