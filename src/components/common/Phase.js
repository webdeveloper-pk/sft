...
const Phase = ({ phase, title, description, borderWidth }) => {
  return (
    <div
      className={`h-[280px] w-[280px] pt-12 pl-12 md:w-[320px] md:h-[320px] md:pt-14 md:pl-16 lg:w-[300px] lg:h-[300px] lg:pt-12 lg:pl-14 xl:w-[320px] xl:h-[320px] xl:pt-14 xl:pl-14 rounded-full border border-8 border-white ${borderWidth} p-4 flex flex-col items-center`}
    >
