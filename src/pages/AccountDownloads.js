          ...
          <div className="flex flex-col md:flex-row justify-between text-black text-sm lg:text-base font-semibold mb-10">
            <div className="w-full md:w-[48%] xl:w-[45%]">
              <p>
                ...
                trading accounts across the globe, and at any time of the day.
                So, we offer the most efficient and powerful range of trading
                platforms on PC, laptops, tablets or mobiles. Choose your
                preferred platform and instantly download it to your device.
              </p>
              <p className="mt-6">
                We offer our clients to trade on the award-winning MetaTrader 4
                platform, which is the world’s most popular trading platform for
                forex traders due to its ease of use and feature-rich
