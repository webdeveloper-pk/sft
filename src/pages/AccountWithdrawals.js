        ...
        <div className="pt-10">
          ...
          <div className="text-black text-sm lg:text-base font-semibold mb-8">
            <p>
              ...
              requests starts and you can easily keep track of your existing and
              past withdrawals. Once you generated profits and traded for the
              relevant period, you may continue with your withdrawal request on
              this page.
            </p>
          </div>
        </div>
